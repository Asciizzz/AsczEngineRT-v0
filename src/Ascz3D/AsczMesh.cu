...
void AsczMesh::append(AzMesh mesh) {
    ...
    // Update global AABB
    // GLB_min_x = fminf(GLB_min_x, mesh.AB_min_x);
    // GLB_min_y = fminf(GLB_min_y, mesh.AB_min_y);
    // GLB_min_z = fminf(GLB_min_z, mesh.AB_min_z);
    // GLB_max_x = fmaxf(GLB_max_x, mesh.AB_max_x);
    // GLB_max_y = fmaxf(GLB_max_y, mesh.AB_max_y);
    // GLB_max_z = fmaxf(GLB_max_z, mesh.AB_max_z);
