...
// =================== Direct lighting =========================
        ...
        float lIntensity = (NdotL * NdotL * hasNrml + !hasNrml)
                            * lm.Ems_i * !occluded;
        radi_x += thru_x * lm.Ems_r * alb_x * lIntensity + !occluded * hm.Ems_r * hm.Ems_i;
        radi_y += thru_y * lm.Ems_g * alb_y * lIntensity + !occluded * hm.Ems_g * hm.Ems_i;
        radi_z += thru_z * lm.Ems_b * alb_z * lIntensity + !occluded * hm.Ems_b * hm.Ems_i;
