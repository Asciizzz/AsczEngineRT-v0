...
*/
        ...
        float vrtx_x = R_ox + R_dx * H_t;
        float vrtx_y = R_oy + R_dy * H_t;
        float vrtx_z = R_oz + R_dz * H_t;
...
// =================== Direct lighting =========================
        ...
        float DL_dx = vrtx_x - DL_vx;
        float DL_dy = vrtx_y - DL_vy;
        float DL_dz = vrtx_z - DL_vz;
        ...
        DL_dx /= Ldist; DL_dy /= Ldist; DL_dz /= Ldist;
        ...
        // Get relevant data
        float LdotN = DL_dx * H_nx + DL_dy * H_ny + DL_dz * H_nz;
        LdotN *= LdotN + !H_hasN;
        ...
        float RADI_i = LdotN * !occluded * LdistRsqr * DL_m.Ems_i;
